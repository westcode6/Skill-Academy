...
export default function Testimonials() {
  ...
  return (
    <>
      <section className="px-6 py-10 pb-20 md:px-16  flex justify-center items-center">
        <div>
          <h2>Student Feedback</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 md:px-24 gap-3 md:gap-12 mt-12">
            {Testimonials.map((each) => (
              <div className="bg-white rounded-xl   px-6 md:px-20  mt-2">
                <img
                  src={each.image}
